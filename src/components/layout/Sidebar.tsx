          ...
          >
            {user?.avatar ? (
              <img
                ...
                className="h-8 w-8 rounded-full object-cover border border-border select-none shrink-0"
              />
            ) : (
            ...
            {!isCollapsed && (
              <div className="flex flex-col min-w-0">
                <span className="text-xs font-semibold text-foreground truncate">{user?.fullName || 'User'}</span>
