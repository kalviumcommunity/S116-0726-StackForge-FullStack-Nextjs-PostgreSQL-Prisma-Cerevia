...
export const metadata: Metadata = {
  ...
  description: 'Create your Cerevia account to start gamifying your learning streak.',
};
    ...
    <div className="w-full rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-xl relative overflow-hidden">
      ...
      <div className="flex flex-col gap-2 text-center mb-8 relative z-10">
        ...
        <p className="text-xs text-muted-foreground">
          Join Cerevia to start gamifying your learning journey today
        </p>
      </div>

      {/* Renders the client-side registration form */}
      <RegisterForm />
    </div>
  );
}
